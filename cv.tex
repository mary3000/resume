...
\footnotesize{
\makecell[l]{Developed new intentions for RubyMine IDEm introduced better parameter \\refactoring: added parameter type choosing option, improved invocation points search,\\ made preview more illustrative.}
}
\end{tabular}
...
\section{Education}
\begin{tabular}{rl}	
 2016 - 2020 (Present) & \textbf{Moscow Institute of Physics and Technology}, Russia\\
